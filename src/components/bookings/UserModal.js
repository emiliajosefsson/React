...
},
{
  ...
  function closeModal(){
    ...
    return (
        <>
            <button
                        className="block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4" onClick={openModal}>Ändra</button>
            <Modal
          isOpen={modalOpen}
          ariaHideApp={false}
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <h2 className=" text-center text-3xl font-extrabold text-pink-700 mb-5">Ändra dina Uppgifter</h2>
